...
$brand_name = fabrika62_opt_str('brand_name', 'Fabrika Ajandek');
?>
  ...
  <section id="hero" class="relative min-h-screen flex items-center justify-center" style="background-color: #3B2314; clip-path: inset(0);">
    ...
    <div class="relative z-10 text-center px-4 max-w-3xl mx-auto">
      ...
      <p class="text-lg sm:text-xl text-[#E8DCC8] mb-10 leading-relaxed max-w-2xl mx-auto">
        <?php echo wp_kses_post(fabrika62_opt_str('hero_subtitle', 'Kezmuves fa ajandekok &ndash; lezergravírozas, fa tablak, kerti diszek, egyedi nyomatok')); ?>
      </p>
      ...
      <a href="<?php echo esc_attr(fabrika62_opt_str('hero_cta_href', '#kapcsolat')); ?>" class="inline-block px-8 py-3.5 rounded-lg font-semibold text-[#FFFBF5] transition-all duration-300 hover:scale-105 hover:shadow-lg" style="background: linear-gradient(135deg, #B87333, #C9A84C); box-shadow: 0 4px 15px rgba(184, 115, 51, 0.35);">
        <?php echo esc_html(fabrika62_opt_str('hero_cta_label', 'Egyedi rendeles')); ?>
      </a>
    </div>
  ...
  <section id="termekek" class="py-20 sm:py-28" style="background-color: #F4EDE4;">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16">
        <h2 class="text-3xl sm:text-4xl font-bold text-[#3B2314] mb-4"><?php echo esc_html(fabrika62_opt_str('products_title', 'Amit a muhelyben keszítunk')); ?></h2>
      ...
      <div class="relative">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          if (!is_array($cats) || $cats === []) {
              $cats = [
                  ['image' => $ref_base . '/01-laser-engraved-magnet.jpg', 'title' => 'Lezergravírozott kepek', 'description' => 'Portrek es mintak, lezertechnologiaval faba vesve.'],
                  ['image' => $ref_base . '/03-handmade-wood-sign-shop-1.jpg', 'title' => 'Fa tablak / feliratok', 'description' => 'Szemelyre szabott feliratok barmilyen alkalomra.'],
                  ['image' => $ref_base . '/05-fridge-magnets.jpg', 'title' => 'Kis ajandektargyak', 'description' => 'Hutomagnesesk, kulcstartok es apro kedvessegek.'],
                  ['image' => $ref_base . '/07-terrariums-florist.jpg', 'title' => 'Kerti diszek / viragtartok', 'description' => 'Kezzel keszített dekoraciok a szabadba.'],
                  ['image' => $ref_base . '/09-california-travel-poster.jpg', 'title' => 'Színes nyomatok', 'description' => 'Egyedi grafikak es illusztraciok, nyomtatva.'],
              ];
          }
  ...
  <section id="galeria" class="py-20 sm:py-28" style="background-color: #E8DCC8;">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16">
        <h2 class="text-3xl sm:text-4xl font-bold text-[#3B2314] mb-4"><?php echo esc_html(fabrika62_opt_str('gallery_title', 'Munkaink')); ?></h2>
        <div class="copper-divider max-w-[200px] mx-auto"></div>
      </div>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        if (!is_array($gallery_items) || $gallery_items === []) {
            $gallery_items = [
                ['image' => $ref_base . '/01-laser-engraved-magnet.jpg', 'alt' => 'Lezergravírozott magnes'],
                ['image' => $ref_base . '/02-laser-engraved-wall-plaque.jpg', 'alt' => 'Lezergravírozott fali tabla'],
                ['image' => $ref_base . '/03-handmade-wood-sign-shop-1.jpg', 'alt' => 'Kezmuves fa tabla'],
                ['image' => $ref_base . '/04-waterfront-rules-wood-sign.jpg', 'alt' => 'Szabalyok fa tabla'],
                ['image' => $ref_base . '/05-fridge-magnets.jpg', 'alt' => 'Hutomagnesesk'],
                ['image' => $ref_base . '/06-picnic-basket-gifts.jpg', 'alt' => 'Piknik kosar ajandek'],
                ['image' => $ref_base . '/07-terrariums-florist.jpg', 'alt' => 'Terrariumok'],
                ['image' => $ref_base . '/08-blue-painted-wall-planters.jpg', 'alt' => 'Fali viragtartok'],
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="relative flex flex-col gap-12 max-w-lg mx-auto">
        ...
        if (!is_array($steps) || $steps === []) {
            $steps = [
                ['title' => 'Meselj az otletedrol', 'description' => 'Valassz meglevo tereket, vagy írd le az egyedi elkepzelesed.'],
  ...
  <section class="py-20 sm:py-28" style="background-color: #E8DCC8;">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16">
        <h2 class="text-3xl sm:text-4xl font-bold text-[#3B2314] mb-4"><?php echo esc_html(fabrika62_opt_str('gifts_title', 'Mikor adj kezmuveset?')); ?></h2>
        <div class="copper-divider max-w-[200px] mx-auto"></div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        if (!is_array($gift_ideas) || $gift_ideas === []) {
            $gift_ideas = [
                ['icon' => 'gift', 'title' => 'Szuletesnap', 'description' => 'Gravírozott keret vagy egyedi fa tabla.'],
                ...
                ['icon' => 'sparkles', 'title' => 'Karacsony', 'description' => 'Fabol keszult unnepi ajandékok.'],
                ['icon' => 'smile', 'title' => 'Csak ugy', 'description' => 'A legjobb ajandek: amire nem szamít.'],
            ];
        }
  ...
  <section class="py-20 sm:py-28" style="background-color: #F4EDE4;">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      <h2 class="text-3xl sm:text-4xl font-bold text-[#3B2314] mb-4"><?php echo esc_html(fabrika62_opt_str('market_title', 'Keress minket szemelyesen!')); ?></h2>
      ...
      <div class="max-w-xl mx-auto rounded-xl p-8 sm:p-10" style="background-color: #FFFBF5; border: 1px solid rgba(184, 115, 51, 0.15); box-shadow: 0 4px 20px rgba(92, 61, 46, 0.08);">
        ...
        <p class="text-lg text-[#3B2314] font-medium mb-3"><?php echo esc_html(fabrika62_opt_str('market_lead', 'Szarvasi es kornyekbeli piacok, vasarok, rendezvenyek.')); ?></p>
        <p class="text-[#5C3D2E]"><?php echo esc_html(fabrika62_opt_str('market_sub', 'Szemelyes atvetel egyeztetessel.')); ?></p>
      </div>
    </div>
  </section>
  ...
  <section id="kapcsolat" class="py-20 sm:py-28" style="background-color: #E8DCC8;">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16">
        <h2 class="text-3xl sm:text-4xl font-bold text-[#3B2314] mb-4"><?php echo esc_html(fabrika62_opt_str('contact_title', 'Irj nekunk!')); ?></h2>
        <div class="copper-divider max-w-[200px] mx-auto"></div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div class="lg:col-span-2">
          ...
          <form class="rounded-xl p-6 sm:p-8 space-y-5" style="background-color: #FFFBF5; border: 1px solid rgba(184, 115, 51, 0.15); box-shadow: 0 4px 20px rgba(92, 61, 46, 0.08);">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                <label for="nev" class="block text-sm font-semibold text-[#3B2314] mb-1.5">Nev *</label>
              ...
              <div>
                ...
                <input type="email" id="email" name="email" required class="w-full rounded-lg border px-4 py-2.5 text-sm focus:outline-none focus:ring-2" style="border-color: rgba(184, 115, 51, 0.25); background: #FFFBF5;" placeholder="pelda@email.com" />
              </div>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                <label for="telefon" class="block text-sm font-semibold text-[#3B2314] mb-1.5">Telefon <span class="font-normal text-[#5C3D2E]">(opcionalis)</span></label>
              ...
              <div>
                <label for="kategoria" class="block text-sm font-semibold text-[#3B2314] mb-1.5">Kategoria</label>
                <select id="kategoria" name="kategoria" class="w-full rounded-lg border px-4 py-2.5 text-sm focus:outline-none focus:ring-2" style="border-color: rgba(184, 115, 51, 0.25); background: #FFFBF5;">
                  ...
                  <option value="lezer">Lezergravírozas</option>
                  <option value="tabla">Fa tablak / feliratok</option>
                  <option value="ajandek">Kis ajandektargyak</option>
                  <option value="kert">Kerti diszek</option>
            ...
            <div>
              <label for="uzenet" class="block text-sm font-semibold text-[#3B2314] mb-1.5">Uzenet *</label>
              <textarea id="uzenet" name="uzenet" required rows="5" class="w-full rounded-lg border px-4 py-2.5 text-sm focus:outline-none focus:ring-2 resize-y" style="border-color: rgba(184, 115, 51, 0.25); background: #FFFBF5;" placeholder="Ird le az elkepzelesed..."></textarea>
            </div>
        ...
        <div class="space-y-6">
          <div class="rounded-xl p-6" style="background-color: #FFFBF5; border: 1px solid rgba(184, 115, 51, 0.15); box-shadow: 0 4px 20px rgba(92, 61, 46, 0.08);">
            <h3 class="font-bold text-[#3B2314] text-lg mb-5">Elerhetosegek</h3>
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <?php $fb_label = fabrika62_opt_str('contact_facebook_label', 'Fabrika Ajandek'); ?>
  ...
  <section class="py-20 sm:py-28" style="background-color: #F4EDE4;">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16">
        <h2 class="text-3xl sm:text-4xl font-bold text-[#3B2314] mb-4"><?php echo esc_html(fabrika62_opt_str('faq_title', 'Gyakori kerdesek')); ?></h2>
        <div class="copper-divider max-w-[200px] mx-auto"></div>
      </div>
      ...
      <div class="space-y-3">
        ...
        if (!is_array($faq_items) || $faq_items === []) {
            $faq_items = [
                ...
                ['question' => 'Kulfldre is kuldtok?', 'answer' => 'Jelenleg csak belfldre.'],
                ['question' => 'Sajat otletet is megvalósítotok?', 'answer' => 'Persze! Kuldj leirast, kepet vagy vazlatot.'],
            ];
        }
